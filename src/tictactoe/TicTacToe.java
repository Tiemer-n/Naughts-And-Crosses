...
//        }
    ...
    public static void InputPlace() throws InterruptedException {
        ...
        System.out.println("Computer is calcualting place...");
        unit.sleep(2000);
        ClearBox();
        unit.sleep(100);
    ...
    public static int minimax(int depth, boolean isMaximising) throws InterruptedException {
    ...
    public static String CheckSystem(int function) throws InterruptedException {
